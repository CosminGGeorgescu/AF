// * Determinați cel mai apropiat punct de control de vârful s şi afișați un lanț minim până la acesta, 
// * folosind algoritmul lui Dijkstra (problema B.2. din laboratorul 1 pentru cazul ponderat) - O(m log(n)).
