/**
 * * Să se determine timpul minim de finalizare a proiectului, știind că acesta începe la ora 0 (echivalent – să se determine durata proiectului) 
 * * și o succesiune (critică) de activități care determină durata proiectului (un drum critic – v. curs) O(m + n).            
